...
<?php } ?>
        ...
        <img class="<?=isset($lazyLoadBool) && $lazyLoadBool == true ? "lazy" : ""?>" <?=isset($lazyLoadBool) && $lazyLoadBool == true ? "data-" : ""?>src="images/<?= isset($imgFilePath) ? $imgFilePath : "noImageFound.jpg"?>"
