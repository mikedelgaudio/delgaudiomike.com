...
<script>
  ...
  gtag('config', 'UA-119776312-1' );
	...
	<meta name="title" content="Mike DelGaudio">
...
<body>
	<div class="backgroundIndex">
		<div class="w3-animate-zoom">
			<div id="container">
  				<a href="/"><p>Error 404</p></a>
			</div>
			<p id="indexText">oh no that's not right</p>
		</div>
	<br>
		<p style="font-size: 1em;"><a href="/" rel="nofollow"><button class="w3-button w3-white w3-round-large">Go home!</button></a></p>
	</div>
</body>
</html>